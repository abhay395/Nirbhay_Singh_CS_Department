...
const getData = async () => {
  let responce = await fetch("https://nirbhay-singh-cs-department-git-main-abhay395s-projects.vercel.app/headline");
...
const updateData = async (updateObje, id) => {
  ...
  try {
    const responce = await fetch(`https://nirbhay-singh-cs-department-git-main-abhay395s-projects.vercel.app/headline/${id}`, {
      method: "PUT",
      // headers: {
...
const deleteData = async (id) => {
  try {
    const response = await fetch(`https://nirbhay-singh-cs-department-git-main-abhay395s-projects.vercel.app/headline/${id}`, {
      method: "DELETE",
    });
    return response;
  } catch (err) {
...
const postData = async (description, type, pdf) => {
  ...
  try {
    const responce = await fetch("https://nirbhay-singh-cs-department-git-main-abhay395s-projects.vercel.app/headline", {
      method: "POST",
      body: formData,
    });
    return responce;
