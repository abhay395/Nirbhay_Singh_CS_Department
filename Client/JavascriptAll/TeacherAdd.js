...
const getData = async () => {
  try {
    const response = await fetch("https://nirbhay-singh-cs-department-git-main-abhay395s-projects.vercel.app/teacher");
...
const updateData = async (
  ...
  try {
    ...
    const response = await fetch(`https://nirbhay-singh-cs-department-git-main-abhay395s-projects.vercel.app/teacher/${id}`, {
      method: "PUT",
      body: formData,
    });
    if (response.ok) {
