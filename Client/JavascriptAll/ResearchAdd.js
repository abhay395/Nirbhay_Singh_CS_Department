...
const getData = async () => {
  try {
    const response = await fetch("https://nirbhay-singh-cs-department-git-main-abhay395s-projects.vercel.app/research");
...
const deleteData = async (id) => {
  try {
    const response = await fetch(`https://nirbhay-singh-cs-department-git-main-abhay395s-projects.vercel.app/research/${id}`, {
      method: "DELETE",
    });
    return response;
  } catch (error) {
