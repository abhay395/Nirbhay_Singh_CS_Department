...
const updateData = async ({ name, cgpa }, id) => {
  ...
  console.log(id);
  try {
    const res = await fetch(`https://nirbhay-singh-cs-department-git-main-abhay395s-projects.vercel.app/student/update/${id}`, {
      method: "PUT",
      body: formdata,
    });
    return res;
...
const postData = async ({
  ...
  try {
    ...
    const response = await fetch("https://nirbhay-singh-cs-department-git-main-abhay395s-projects.vercel.app/student/create", {
      method: "POST",
      body: formdata,
    });
   if(response.ok){
...
const getData = async () => {
  try {
    const response = await fetch(
      `https://nirbhay-singh-cs-department-git-main-abhay395s-projects.vercel.app/student/getAll?examYear=${examyear}&course=${course}`
    );
...
const deleteStudent = async (id) => {
  try {
    const response = await fetch(`https://nirbhay-singh-cs-department-git-main-abhay395s-projects.vercel.app/student/delete/${id}`, {
      method: "DELETE",
    });
    return response;
  } catch (error) {
